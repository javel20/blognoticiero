...
<br>
    <form action="" id="form" class="container">
        ...
        <input type="button" class="btn btn-primary" id="insertartn" name="insertartn" value="insertar">
        <input type="button" class="btn btn-primary" id="actualizartn" name="actualizartn" value="actualizar">
    ...
    <script src="tiponoticia.js"></script>
</body>
</html>