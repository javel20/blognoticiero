...
<br>
    ...
    <div class="row my-3">
        <div class="col-4">
            <select class="form-select" aria-label="Default select example" id="tu" name="id_tipo_usuario">
                    <option value="">Selecciona una opción</option>
            </select>
        </div>

        <div class="col-4">
            <input type="text" class="form-control" id="nombre_usuario" name="nombre_usuario" placeholder="Ingrese Nombre">
        </div>
